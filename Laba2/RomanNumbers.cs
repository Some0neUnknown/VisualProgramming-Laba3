  ...
  public class RomanNumber : ICloneable, IComparable
    ...
    public override string ToString()
    {
        ...
        private static string toRoman(int number)
        {
            ...
            if (number >= 40000) return "X`L`" + toRoman(number - 40000);
            if (number >= 10000) return "X`" + toRoman(number - 10000);
            if (number >= 9000) return "MX`" + toRoman(number - 9000);
            if (number >= 5000) return "V`" + toRoman(number - 5000);
            if (number >= 4000) return "MV`" + toRoman(number - 4000);
        ...
        public int CompareTo(object obj)
        {
            ...
            else throw new RomanNumberException("wrong argument");
        }
